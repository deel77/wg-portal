...
const cryptoMessage = computed(() => {
  let msg = settings.Setting("ClientSidePeerKeygen")
    ? t("modals.peer-edit.info-client-keygen")
    : t("modals.peer-edit.info-server-keygen");
  if (!settings.Setting("StorePrivateKeys")) {
    msg += " " + t("modals.peer-edit.info-not-saved");
  }
  msg += " " + t("modals.peer-edit.info-safety");
  return msg;
});
...
const title = computed(() => {
  ...
  if (selectedInterface.value.Mode === "server") {
    if (selectedPeer.value) {
      return (
        t("modals.peer-edit.headline-edit-peer") +
        " " +
        selectedPeer.value.Identifier
      );
    }
    ...
    if (selectedPeer.value) {
      return (
        t("modals.peer-edit.headline-edit-endpoint") +
        " " +
        selectedPeer.value.Identifier
      );
    }
  ...
  async (newValue, oldValue) => {
    if (oldValue === false && newValue === true) {
      ...
      if (!selectedPeer.value) {
        ...
        if (settings.Setting("ClientSidePeerKeygen")) {
          const kp = await generateKeypair();
          formData.value.PrivateKey = kp.privateKey;
          formData.value.PublicKey = kp.publicKey;
          formData.value.Identifier = kp.publicKey;
          const psk = generatePresharedKey();
          formData.value.PresharedKey = arrayBufferToBase64(psk);
        } else {
        ...
        formData.value.InterfaceIdentifier =
          selectedPeer.value.InterfaceIdentifier;
        ...
        formData.value.PersistentKeepalive =
          selectedPeer.value.PersistentKeepalive;
        ...
        if (
          !formData.value.Endpoint.Overridable ||
  ...
  try {
    if (props.peerId !== "#NEW#") {
      ...
      await peers.CreatePeer(
        selectedInterface.value.Identifier,
        formData.value,
      );
    }
    close();
  ...
  <Modal :title="title" :visible="visible" @close="close">
    <template #default>
      <fieldset>
        ...
        <div class="form-group">
          ...
          <input
            type="text"
            class="form-control"
            :placeholder="$t('modals.peer-edit.display-name.placeholder')"
        ...
        <div class="form-group">
          ...
          <input
            type="text"
            class="form-control"
            :placeholder="$t('modals.peer-edit.linked-user.placeholder')"
      ...
      <fieldset>
        ...
        <p class="alert alert-info">{{ cryptoMessage }}</p>
        <div class="form-group" v-if="selectedInterface.Mode === 'server'">
          ...
          <input
            type="text"
            class="form-control"
            :placeholder="$t('modals.peer-edit.private-key.placeholder')"
            required
        ...
        <div class="form-group">
          ...
          <input
            type="text"
            class="form-control"
            :placeholder="$t('modals.peer-edit.public-key.placeholder')"
            required
        ...
        <div class="form-group">
          ...
          <input
            type="text"
            class="form-control"
            :placeholder="$t('modals.peer-edit.preshared-key.placeholder')"
        ...
        <div class="form-group" v-if="formData.Mode === 'client'">
          ...
          <input
            ...
            class="form-control"
            :placeholder="
              $t('modals.peer-edit.endpoint-public-key.placeholder')
            "
      ...
      <fieldset>
        ...
        <div class="form-group" v-if="selectedInterface.Mode === 'client'">
          ...
          <input
            type="text"
            class="form-control"
            :placeholder="$t('modals.peer-edit.endpoint.placeholder')"
        ...
        <div class="form-group">
          ...
          <vue-tags-input
            class="form-control"
            v-model="currentTags.AllowedIPs"
        ...
        <div class="form-group">
          ...
          <vue-tags-input
            class="form-control"
            v-model="currentTags.ExtraAllowedIPs"
        ...
        <div class="row">
          <div class="form-group col-md-6">
            <label class="form-label mt-4">{{
              $t("modals.peer-edit.keep-alive.label")
            }}</label>
            <input
              type="number"
              class="form-control"
              :placeholder="$t('modals.peer-edit.keep-alive.label')"
              v-model="formData.PersistentKeepalive.Value"
            />
          </div>
          <div class="form-group col-md-6">
            <label class="form-label mt-4">{{
              $t("modals.peer-edit.mtu.label")
            }}</label>
            <input
              type="number"
              class="form-control"
              :placeholder="$t('modals.peer-edit.mtu.label')"
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <textarea
            v-model="formData.PreUp.Value"
            class="form-control"
            rows="2"
            :placeholder="$t('modals.peer-edit.pre-up.placeholder')"
          ></textarea>
        </div>
        <div class="form-group">
          <label class="form-label mt-4">{{
          ...
          <textarea
            v-model="formData.PostUp.Value"
            class="form-control"
            rows="2"
            :placeholder="$t('modals.peer-edit.post-up.placeholder')"
          ></textarea>
        </div>
        <div class="form-group">
          <label class="form-label mt-4">{{
          ...
          <textarea
            v-model="formData.PreDown.Value"
            class="form-control"
            rows="2"
            :placeholder="$t('modals.peer-edit.pre-down.placeholder')"
          ></textarea>
        </div>
        <div class="form-group">
          <label class="form-label mt-4">{{
          ...
          <textarea
            v-model="formData.PostDown.Value"
            class="form-control"
            rows="2"
            :placeholder="$t('modals.peer-edit.post-down.placeholder')"
          ></textarea>
        </div>
      </fieldset>
      <fieldset>
          ...
          <div class="form-group col-md-6">
            <div class="form-check form-switch">
              ...
              <label class="form-check-label">{{
                $t("modals.peer-edit.disabled.label")
              }}</label>
            </div>
            <div class="form-check form-switch">
              <input
                class="form-check-input"
                type="checkbox"
                v-model="formData.IgnoreGlobalSettings"
              />
              <label class="form-check-label">{{
                $t("modals.peer-edit.ignore-global.label")
              }}</label>
            </div>
          </div>
          <div class="form-group col-md-6">
    ...
    <template #footer>
      ...
      <button class="btn btn-primary me-1" type="button" @click.prevent="save">
        {{ $t("general.save") }}
      </button>
      <button class="btn btn-secondary" type="button" @click.prevent="close">
        {{ $t("general.close") }}
      </button>
    </template>
  </Modal>
